...
fs.copySync('./node_modules/ui5lab-browser/dist/', './test/common/browser');

// read library namespace from package.json
var oPackage = require('./package.json');
var sNamespace = oPackage.common.namespace || "com.cerner.scp.augero.common.controls";

// add library namespace to browser library list
var sBrowserLibraryFile = './test/common/browser/libraries.json';
